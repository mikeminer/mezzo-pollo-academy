...
(function () {
  ...
  const copy = {
    en: {
      ...
      accessIntro: 'Playing requires at least 1,000,000 MEMEZZO summed across active DevFridge timelocks of the same connected Phantom wallet and mint. No minimum duration applies; expired locks stop counting. Mint:',
      accessOutro: '. There is no free-play route or cosmetic-only unlock.',
    ...
    it: {
      ...
      accessIntro: 'Per giocare servono almeno 1.000.000 MEMEZZO, sommati tra i timelock DevFridge attivi dello stesso wallet Phantom collegato e dello stesso token. Non c’è una durata minima; i timelock scaduti non contano più. Indirizzo del token:',
      accessOutro: '. Non sono previste partite gratuite né sblocchi soltanto estetici.',
    ...
    pl: {
      ...
      accessIntro: 'Aby zagrać, potrzebujesz co najmniej 1 000 000 MEMEZZO łącznie w aktywnych blokadach czasowych DevFridge dla tego samego połączonego portfela Phantom i tokena. Nie ma minimalnego czasu blokady; wygasłe blokady przestają się liczyć. Adres tokena:',
      accessOutro: '. Nie ma trybu darmowej gry ani odblokowania wyłącznie elementów kosmetycznych.',
